function Vinyl({ size, className, id }: { size: number; className?: string; id: string }) {
    return (
        <svg width={size} height={size} viewBox="0 0 200 200" className={className}>
            <circle cx="100" cy="100" r="98" fill="#1c1917" />
            <circle cx="100" cy="100" r="80" fill="none" stroke="#292524" strokeWidth="1" />
            <circle cx="100" cy="100" r="65" fill="none" stroke="#292524" strokeWidth="1" />
            <circle cx="100" cy="100" r="50" fill="none" stroke="#292524" strokeWidth="1" />

            <circle cx="100" cy="100" r="35" fill="#b45309" />

            <path id={id} d="M 100,100 m -25,0 a 25,25 0 1,1 50,0 a 25,25 0 1,1 -50,0" fill="none" />
            <text fontSize="11" fontWeight="700" letterSpacing="2" fill="#1c1917">
